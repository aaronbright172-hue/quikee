...
function CheckoutClientPage() {
  ...
  const [showCryptoSelectionModal, setShowCryptoSelectionModal] =
    useState(false);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link
            href="/"
            className="inline-block px-8 py-3 bg-black text-white rounded-lg hover:bg-neutral-800"
          >
            Continue Shopping
          </Link>
        </div>
      ...
      <div className="min-h-screen bg-neutral-50">
        ...
        <div className="bg-white border-b border-neutral-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <Link
              href="/"
              className="flex items-center gap-2 text-black hover:text-neutral-600 w-fit"
            >
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              >
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg mb-4 focus:outline-none focus:border-black ${
                    formInteracted && !formData.email
                      ? "border-red-500"
                      : "border-neutral-300"
                  }`}
                />
              ...
              <div className="bg-white rounded-lg p-8 border border-neutral-200">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg mb-4 focus:outline-none focus:border-black ${
                    formInteracted && !formData.country
                      ? "border-red-500"
                      : "border-neutral-300"
                  }`}
                >
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`px-4 py-3 border rounded-lg focus:outline-none focus:border-black ${
                      formInteracted && !formData.firstName
                        ? "border-red-500"
                        : "border-neutral-300"
                    }`}
                  />
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`px-4 py-3 border rounded-lg focus:outline-none focus:border-black ${
                      formInteracted && !formData.lastName
                        ? "border-red-500"
                        : "border-neutral-300"
                    }`}
                  />
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg mb-4 focus:outline-none focus:border-black ${
                    formInteracted && !formData.address
                      ? "border-red-500"
                      : "border-neutral-300"
                  }`}
                />
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`px-4 py-3 border rounded-lg focus:outline-none focus:border-black ${
                      formInteracted && !formData.postcode
                        ? "border-red-500"
                        : "border-neutral-300"
                    }`}
                  />
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          ...
                          <g fill="none">
                            ...
                            <path
                              fill="#006FCF"
                              d="M35,1 C36.1,1 37,1.9 37,3 L37,21 C37,22.1 36.1,23 37,23 L3,23 C1.9,23 1,22.1 1,21 L1,3 C1,1.9 1.9,1 3,1 L35,1"
                            />
                            <path
                              fill="#FFF"
              ...
              <div className="bg-white rounded-lg p-8 border border-neutral-200 mt-8">
                {" "}
                ...
                >
                  <div className="space-y-4 text-sm text-neutral-600">
                    <p>
                      You are about to pay using cryptocurrency. Due to its
                      nature cryptocurrencies, tokens, and digital assets are
                      irreversible, and their exchange rates are highly volatile
                      and transitory. We can not be responsible for any risk
                      including but not limited to exchange rate risk and market
                      risk.
                    </p>
                    <p>
                      Please note that crypto payments are not received
                      instantly as they require multiple confirmations on the
                      blockchain. Payment confirmation can take up to few hours
                      but usually happens within 20 min.
                    </p>
                    <button
